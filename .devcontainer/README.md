## docker of segment-anything-test-dev
...
- build docker
    ```shell
    docker build . -t samge/segment-anything-test-dev-base -f .devcontainer/Dockerfile-dev-base --build-arg PROXY=http://192.168.50.48:7890
    ```

- upload
    ```shell
    docker push samge/segment-anything-test-dev-base
    ```
